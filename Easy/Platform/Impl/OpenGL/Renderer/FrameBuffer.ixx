...
namespace Easy {
    ...
    public:
        ...
        virtual uint32_t GetColorAttachmentRendererID(uint32_t index = 0) const override { EZ_CORE_ASSERT(index < m_ColorAttachments.size()); return m_ColorAttachments[index]; }
