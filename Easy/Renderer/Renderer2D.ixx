...
namespace Easy {
    ...
    public:
        ...
        static void DrawQuad(const glm::vec2 &position, const glm::vec2 &size, const Arc<Texture2D> &texture,
                             float tilingFactor = 1.0f, const glm::vec4 &tintColor = glm::vec4(1.0f));

        static void DrawQuad(const glm::vec3 &position, const glm::vec2 &size, const Arc<Texture2D> &texture,
                             float tilingFactor = 1.0f, const glm::vec4 &tintColor = glm::vec4(1.0f));

        static void DrawQuad(const glm::mat4 &transform, const glm::vec4 &color, int entityID = -1);

        static void DrawQuad(const glm::mat4 &transform, const Arc<Texture2D> &texture, float tilingFactor = 1.0f,
        ...
        static void DrawString(const std::string &string, Arc<Font> font, const glm::mat4 &transform,
