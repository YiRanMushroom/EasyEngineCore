module Easy.Renderer.ShaderSources;

import Easy.Core.Basic;
import Easy.Core.Util;

namespace Easy::GLShaderSources {
    bool PeakFile(const std::filesystem::path &path, std::string_view string_to_write) {
    ...
    using namespace std::string_literals; // sv

    // Shaders from Hazel
    constexpr std::string_view FlatColorSrc = R"(
// Flat Color Shader
...
void main()
{
    ...
    constexpr std::string_view Renderer2D_CircleSrc = R"(
//--------------------------
// - Hazel 2D -
...
void main()
{
	...
	constexpr std::string_view Renderer2D_LineSrc = R"(
//--------------------------
// - Hazel 2D -
...
void main()
{
	...
	constexpr std::string_view Renderer2D_QuadSrc = R"(
...
void main()
{
	...
	constexpr std::string_view Renderer2D_TextSrc = R"(
// MSDF text shader
...
void main()
{
    ...
    void Init() {
    	...
    	PeakFile("assets/shaders/Renderer2D_Quad.glsl", Renderer2D_QuadSrc);
    	PeakFile("assets/shaders/Renderer2D_Text.glsl", Renderer2D_TextSrc);
    }
}
