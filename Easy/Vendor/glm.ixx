...
namespace glm {
    ...
    export using glm::zero;
    export using glm::identity;

    export struct zero_any_t {
        template<typename T> requires requires { glm::zero<T>(); }
        constexpr T operator()() const {
            return glm::zero<T>();
        }
    } zero_any;

    export struct identity_any_t {
        template<typename T> requires requires { glm::identity<T>(); }
        constexpr T operator()() const {
